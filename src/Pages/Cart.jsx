  ...
  return (
    <Container>
        ...
        <div className='row w-100  d-flex flex-row'>
          {cartArray?.length > 0 ?
            <div className='col-lg-6 m-5 ms-2 w-50'>
              <table className='table shadow border w-50 ms-5'>
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Product</th>
          ...
          {cartArray.length > 0 && (
            <div className='col-lg-4 card shadow border  mb-auto mt-5'>
              ...
              <button className='btn btn-success w-100 rounded mb-3' onClick={()=>addToOrder(cartArray)}>Checkout & Pay</button>
            </div>
          )}
